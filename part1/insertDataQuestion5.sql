...
(SELECT dog_id FROM Dogs WHERE name = 'Humzah'), '2025-06-10 10:00:00', 30, 'Downtown', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Big Fella'), '2025-06-10 11:00:00', 30, 'Greenfield Park', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name = 'Small Fella'), '2025-06-10 12:00:00', 45, 'Riverwalk', 'open');
